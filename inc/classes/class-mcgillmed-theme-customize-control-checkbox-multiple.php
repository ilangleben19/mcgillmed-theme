...
if (class_exists('WP_Customize_Control') && !class_exists('Mcgillmed_Theme_Customize_Control_Checkbox_Multiple')) :
    ...
    class Mcgillmed_Theme_Customize_Control_Checkbox_Multiple extends WP_Customize_Control
    {
