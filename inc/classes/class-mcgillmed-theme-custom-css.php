...
if (!class_exists('Mcgillmed_Theme_Custom_CSS')) :
    class Mcgillmed_Theme_Custom_CSS
    {
        ...
        public static function get_customizer_css($view = 'front-end')
        {
            ...
            $color_options    = Mcgillmed_Theme_Customizer::get_color_options();

            // Determine if dark mode is enabled.
            $dark_mode_enabled = get_theme_mod('mcgillmed_theme_enable_dark_mode_palette', false);
                ...
                foreach ($color_options as $group_name => $group_color_options) {
                    ...
                    foreach ($group_color_options as $color_option_name => $color_option) {
                        ...
                        $colors[$group_name][$color_option['slug']] = array(
                            'css_variable'  => '--mcgillmed-theme-' . $color_option['slug'] . '-color',
                            'color'         => get_theme_mod($color_option_name, $color_option['default']),
                        );
                    }
                }
            ...
            if ($background_color != $background_color_default) {
                $colors['regular']['background'] = array(
                    'css_variable'    => '--mcgillmed-theme-background-color',
            ...
            $output_p3 = apply_filters('mcgillmed_theme_custom_css_output_p3_colors', true);
