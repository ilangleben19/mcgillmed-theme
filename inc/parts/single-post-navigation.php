        ...
        ?>
            ...
            <div class="col">
                ...
                <a class="single-nav-item do-spot spot-fade-up<?php echo esc_attr($link_classes); ?>" href="<?php echo esc_url(get_permalink($nav_post->ID)); ?>">
                    ...
                    <?php
                    do_action('mcgillmed_theme_single_nav_item_start', $nav_post, $slug);
                    ?>
                    ...
                    <figure class="single-nav-item-media">
                        ...
                        if ($has_media) {
                            if (has_post_thumbnail($nav_post->ID) && !post_password_required($nav_post->ID)) {
                                echo get_the_post_thumbnail($nav_post->ID, 'mcgillmed_theme_preview_image');
                            } else {
                                echo $fallback_image;
                            }
                        }
                        ...
                        <div class="arrow stroke-cc">
                            <?php mcgillmed_theme_the_theme_svg('ui', $icon, 96, 49); ?>
                        </div><!-- .arrow -->
                    ...
                    if ($nav_post_title || has_action('mcgillmed_theme_single_nav_item_header_start') || has_action('mcgillmed_theme_single_nav_item_header_end')) :
                    ?>

                        <header class="single-nav-item-header contain-margins">

                            <?php
                            do_action('mcgillmed_theme_single_nav_item_header_start', $nav_post, $slug);
                            ?>
                            ...
                            <?php
                            do_action('mcgillmed_theme_single_nav_item_header_end', $nav_post, $slug);
                            ?>
                    ...
                    do_action('mcgillmed_theme_single_nav_item_end', $nav_post, $slug);
