(function ($) {
    ...
    var dark_mode_setting = '#customize-control-mcgillmed_theme_enable_dark_mode_palette input',
        dark_mode_colors = 'li[id^="customize-control-mcgillmed_theme_dark_mode_"]';
