 ...
 * doesn't exist, this page template is unlisted by mcgillmed_theme_conditional_page_templates().
 */
...
<main id="site-content" role="main">
    ...
    <div class="site-content-inner">
        ...
        $archive_title             = get_theme_mod('mcgillmed_theme_jetpack_portfolio_archive_text', '') ? get_theme_mod('mcgillmed_theme_jetpack_portfolio_archive_text', '') : get_the_title();
                ...
                <?php if ($use_header_grid) : ?>
                    ...
                    <div class="archive-header-grid grid cols-tl-6 no-v-gutter">
                        ...
                        if ($archive_title) :
                            ...
                            if (get_theme_mod('mcgillmed_theme_jetpack_portfolio_archive_text', '')) :
                            ?>
